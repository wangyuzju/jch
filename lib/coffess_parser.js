...
(function() {
  ...
  Coffess = (function() {
    ...
    Coffess.prototype._wrapJchInfo = function(source, type, indexHash) {
      this._id = "" + this._prjFp + "_" + type + "_" + indexHash;
      ...
      switch (type) {
        case "text/less":
          ...
          return exec("lessc " + tempFile, function(err, stdout, stderr) {
            ...
            return jchSaver.insert(self._wrapJchInfo(stdout, type, indexHash), {
              target: target,
              id: self._id,
              fileName: self._fp
            });
        ...
        default:
          return jchSaver.insert(this._wrapJchInfo(source, type, indexHash), {
            target: target,
            from: this._fp,
            id: this._id
          });
